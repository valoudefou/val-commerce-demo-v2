import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, provide, defineAsyncComponent, computed, unref, h, Suspense, nextTick, mergeProps, ref, Fragment, createVNode, resolveDynamicComponent, useSSRContext, withCtx, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "/Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/node_modules/radix3/dist/index.mjs";
import { defu } from "/Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "/Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/node_modules/ufo/dist/index.mjs";
import { ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense } from "vue/server-renderer";
import { useHead as useHead$1, headSymbol } from "/Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import("./_nuxt/cart-g_w76Njl.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-KvPAzM8g.js")
  },
  {
    name: "products-slug",
    path: "/products/:slug()",
    component: () => import("./_nuxt/_slug_-BdB1TUFi.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CyONSKWq.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DePov_3y.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-9WZNcJyV.js"));
