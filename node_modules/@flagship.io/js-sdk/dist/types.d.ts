...
export type IHit = Omit<IPage, 'createdAt' | 'visitorId' | 'anonymousId' | 'ds' | 'qaMode' | 'isActionTrackingHit'> | Omit<IScreen, 'createdAt' | 'visitorId' | 'anonymousId' | 'ds' | 'qaMode' | 'isActionTrackingHit'> | Omit<IEvent, 'createdAt' | 'visitorId' | 'anonymousId' | 'ds' | 'qaMode' | 'isActionTrackingHit'> | Omit<IItem, 'createdAt' | 'visitorId' | 'anonymousId' | 'ds' | 'qaMode' | 'isActionTrackingHit'> | Omit<ITransaction, 'createdAt' | 'visitorId' | 'anonymousId' | 'ds' | 'qaMode' | 'isActionTrackingHit'>;
export type FlagDTO = {
    key: string;
    campaignId: string;
    campaignName: string;
...
export declare enum ABTastyWebSDKPostMessageType {
