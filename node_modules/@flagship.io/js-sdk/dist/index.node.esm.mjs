...
import * as __WEBPACK_EXTERNAL_MODULE_node_fetch_e2fb16d6__ from "node-fetch";
 ...
 */
class Visitor extends external_events_.EventEmitter {
    visitorDelegate;
...
class VisitorAbstract extends external_events_.EventEmitter {
    _visitorId;
    _context;
    _flags;
    _configManager;
...
var node_abort_controller = __webpack_require__(985);
;// external "node-fetch"
var x = (y) => {
	var x = {}; __webpack_require__.d(x, y); return x
} 
var y = (x) => (() => (x))
const external_node_fetch_namespaceObject = x({ ["default"]: () => (__WEBPACK_EXTERNAL_MODULE_node_fetch_e2fb16d6__["default"]) });
;// ./src/depsNode.ts
...
function getHttpAgent() {
    ...
    if (typeof window === 'undefined') {
        ...
        const { Agent: HttpAgent } = __webpack_require__(611);
        // eslint-disable-next-line @typescript-eslint/no-require-imports
        const { Agent: HttpAgents } = __webpack_require__(692);
...
const myFetch = async (input, init) => {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return (0,external_node_fetch_namespaceObject["default"])(input, {
        ...globalOption,
        ...init
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
    });
...
class HttpClient {
    ...
    getAbortController() {
        const AbortCtrl = typeof globalThis.AbortController !== 'undefined'
            ...
            : node_abort_controller.AbortController;
...
;// ./src/emotionAI/EmotionAI.node.ts
class EmotionAI {
    constructor(_params) {
        //
    }
...
;// ./src/visitor/VisitorProfileCache.node.ts
...
//# sourceMappingURL=index.node.esm.mjs.map