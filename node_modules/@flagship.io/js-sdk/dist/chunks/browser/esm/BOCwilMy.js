    ...
    initSDKInfo(language, sdkVersion) {
        switch (language) {
            case 1:
                ...
                SDK_INFO.version = sdkVersion ?? version;
                break;
            case 2:
...
const ERROR_MESSAGE$8 = 'event category and event action are required';
/**
...
const ERROR_MESSAGE$7 = 'data property is required';
...
const ERROR_MESSAGE$6 = 'event category and event action are required';
...
const ERROR_MESSAGE$5 = 'Screen name is required';
...
const ERROR_MESSAGE$4 = 'variationGroupId and variationId are required';
...
const BATCH = 'BATCH';
const ERROR_MESSAGE$3 = 'Please check required fields';
    ...
    sendHitsToFsQa(hits) {
        {
            ...
            import('./C5Km5D0Q.js').then(function (n) { return n.i; }).then((message) => {
...
const ERROR_MESSAGE$2 = 'Transaction Id, Item name and item code are required';
...
const ERROR_MESSAGE$1 = 'documentLocation url is required';
...
class StrategyAbstract {
    ...
    reportEaiVisitorEvent(event) {
        {
            Promise.resolve().then(function () { return VisitorEvent$1; }).then(({ VisitorEvent }) => {
    ...
    reportEaiPageView(pageView) {
        {
            Promise.resolve().then(function () { return PageView$1; }).then(({ PageView }) => {
    ...
    sendVisitorAllocatedVariations() {
        {
            ...
            import(/* webpackMode: "lazy" */ './C5Km5D0Q.js').then(function (n) { return n.i; }).then((message) => {
...
class VisitorAbstract extends EventEmitter {
    _visitorId;
    _context;
    _flags;
    _configManager;
    ...
    async sendExposedVariation(flag) {
        {
            ...
            const BATCH_SIZE = 10;
            const DELAY = 100;
            const message = await import('./C5Km5D0Q.js').then(function (n) { return n.i; });
...
var PageView$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    PageView: PageView
});
...
var VisitorEvent$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
...
class Flagship {
    ...
    static async start(envId, apiKey, config) {
        ...
        {
            import('./DQtPWhAC.js').then((qaAssistant) => {
...
export { VisitorCacheStatus as $, LOCATION_COUNTRY as A, LOCATION_LAT as B, CacheStrategy as C, DecisionApiConfig as D, EventCategory as E, FS_QA_ASSISTANT_SCRIPT_TAG_ID as F, LOCATION_LONG as G, HitType as H, IP as I, OS_VERSION_NAME as J, OS_VERSION_CODE as K, LogLevel as L, CARRIER_NAME as M, INTERNET_CONNECTION as N, OS_NAME as O, APP_VERSION_NAME as P, QA_ASSISTANT_LOCAL_URL as Q, APP_VERSION_CODE as R, SDK_INFO as S, TAG_QA_URL as T, INTERFACE_NAME as U, Visitor as V, FLAGSHIP_CLIENT as W, FLAGSHIP_VERSION as X, FLAGSHIP_VISITOR as Y, FLAGSHIP_CONTEXT as Z, TroubleshootingLabel as _, FS_QA_URL as a, ABTastyWebSDKPostMessageType as a0, FSFlag as a1, FSFlagMetadata as a2, FSFlagCollection as a3, FS_FORCED_VARIATIONS as b, FS_IS_QA_MODE_ENABLED as c, TRUSTED_QA_ORIGINS as d, QA_ASSISTANT_PROD_URL as e, QA_ASSISTANT_STAGING_URL as f, TAG_QA_ASSISTANT_LOCAL as g, FS_QA_ASSISTANT_LOCAL as h, isBrowser as i, TAG_QA_ASSISTANT_STAGING as j, FS_QA_ASSISTANT_STAGING as k, logInfoSprintf as l, TAG_QA_ASSISTANT as m, FS_QA_ASSISTANT as n, onDomReady as o, Flagship as p, DecisionMode as q, FSSdkStatus as r, FSFetchReasons as s, FSFetchStatus as t, FSFlagStatus as u, DEVICE_LOCALE as v, DEVICE_TYPE as w, DEVICE_MODEL as x, LOCATION_CITY as y, LOCATION_REGION as z };
//# sourceMappingURL=BOCwilMy.js.map
